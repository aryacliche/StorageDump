...
bool lab_marks(int &total_marks){ //Honestly we could have used a much simpler code that just keeps count of number of 0 and 1 (due to input constraints) but I am like Salman Khan- I do things once I decide I will do them
 ...
 main_program{
    int total_marks=0;
    bool a=lab_marks(total_marks);
    if(a==true) cout<<"true ";
    else cout<<"false ";
    cout<<total_marks<<endl;
    bool b=quiz_marks(total_marks);
    if(b==true) cout<<"true ";
    else cout<<"false ";
    cout<<total_marks<<endl;
    total_marks+=midsem_marks()+endsem_marks();
    cout<<total_marks<<endl;
    bool c=project_marks(total_marks);
    if(c==true) cout<<"true ";
    else cout<<"false ";
    cout<<total_marks<<endl;
    cout<<"grade="<<calculate_grade(total_marks,a,b,c);
 }
