...
-- state_out[1]	=>  Location: PIN_113,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \dut_instance|add_instance|D[2]~0_combout\ = (\dut_instance|add_instance|ff2|Q~q\ & (\dut_instance|add_instance|ff3|Q~q\ & !\dut_instance|add_instance|ff1|Q~q\)) # (!\dut_instance|add_instance|ff2|Q~q\ & (!\dut_instance|add_instance|ff3|Q~q\ & 
-- \dut_instance|add_instance|ff1|Q~q\))
...
-- Equation(s):
-- \dut_instance|add_instance|D[1]~1_combout\ = (!\dut_instance|add_instance|ff2|Q~q\ & ((!\dut_instance|add_instance|ff3|Q~q\) # (!\dut_instance|add_instance|ff1|Q~q\)))
