...
SIGNAL \add_instance|cout~0_combout\ : std_logic;
...
\add_instance|cout~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \add_instance|cout~0_combout\ = (\input_vector[2]~input_o\ & ((\input_vector[0]~input_o\) # (\input_vector[1]~input_o\))) # (!\input_vector[2]~input_o\ & (\input_vector[0]~input_o\ & \input_vector[1]~input_o\))
...
PORT MAP (
	...
	combout => \add_instance|cout~0_combout\);

-- Location: LCCOMB_X20_Y1_N26
\add_instance|s~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \add_instance|s~0_combout\ = \input_vector[2]~input_o\ $ (\input_vector[0]~input_o\ $ (\input_vector[1]~input_o\))
