...
SIGNAL \add_instance|n5|Y~0_combout\ : std_logic;
...
\add_instance|n5|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \add_instance|n5|Y~0_combout\ = \input_vector[1]~input_o\ $ (\input_vector[0]~input_o\)
...
PORT MAP (
	...
	combout => \add_instance|n5|Y~0_combout\);
